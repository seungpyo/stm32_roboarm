...
#define SPI_SR_BSY_MASK (0x0080)
#define SPI_SR_OVR_MASK (0x0400)
#define SPI_SR_MODF_MASK (0x0020)
#define SPI_SR_CRCERR_MASK (0x0010)
#define SPI_SR_TXE_MASK (0x0002)
#define SPI_SR_RXNE_MASK (0x0001)
